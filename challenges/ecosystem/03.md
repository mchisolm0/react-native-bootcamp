...
### Typing functional components with `TypeScript`
...
export function StarshipCard({
  ...
  // No extra line here, like in the previous example
  return <Card>...</Card>;
}
```
...
- I was like you —when I started using `TypeScript`— feeling lost. You can bookmark the [Typescript cheatsheet](https://github.com/typescript-cheatsheets/react), it may help you to answer all your questions.
