...
- [ ] Add 3 [JavaScript Snippets](https://github.com/nathanchapman/vscode-javascript-snippets) to your `cheatcodes.md`.
...
This plugin makes debugging much easier by automating the operation of writing a meaningful log message.
